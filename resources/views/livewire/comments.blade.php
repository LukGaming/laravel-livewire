...
<div class="container">
        <input type="text" name="mensagem" id="inputMensagem" 
            style="margin-right: 10px;margin-top: 200px; margin-bottom:20px; width: 93%" wire:model.lazy="newComment">
        <input class="btn btn-primary" type="submit"  style="width: 7%" value="Enviar">
